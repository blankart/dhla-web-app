...
export class TeacherComponentView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-teacher-component-view fh">
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherComponentView);
