...
import RegistrarViewPastRecords from './RegistrarViewPastRecords';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class RegistrarViewPastRecordsView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-registrar-view-past-records-view fh">
        {this.state.isLoading ? (
          ...
          <NavBar>
            <Container>
              <Grid.Row>
                <Grid.Col xs={12} sm={12} md={12}>
                  <RegistrarViewPastRecords id={this.props.match.params.id} />
                </Grid.Col>
              </Grid.Row>
            </Container>
          </NavBar>
...
export default connect(mapStateToProps, mapDispatchToProps)(RegistrarViewPastRecordsView);
