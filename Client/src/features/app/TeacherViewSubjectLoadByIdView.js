...
import TeacherViewSubjectLoadById from './TeacherViewSubjectLoadById';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class TeacherViewSubjectLoadByIdView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-teacher-view-subject-load-by-id-view">
        {this.state.isLoading ? (
          ...
          <NavBar>
            <Container>
              <Grid.Row>
                <Grid.Col xs={12} sm={12} md={12}>
                  <TeacherViewSubjectLoadById subsectID={this.props.match.params.id} />
                </Grid.Col>
              </Grid.Row>
            </Container>
          </NavBar>
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherViewSubjectLoadByIdView);
