...
export class RegistrarViewStudentRecordGradeView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-registrar-view-student-record-grade-view fh">
        {' '}
...
export default connect(mapStateToProps, mapDispatchToProps)(RegistrarViewStudentRecordGradeView);
