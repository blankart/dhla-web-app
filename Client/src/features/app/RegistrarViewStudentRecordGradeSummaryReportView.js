...
import RegistrarSummaryReport from './RegistrarSummaryReport';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class RegistrarViewStudentRecordGradeSummaryReportView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-registrar-view-student-record-grade-summary-report-view fh">
