...
import TeacherEditRecord from './TeacherEditRecord';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class TeacherEditRecordView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-teacher-edit-record-view fh">
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherEditRecordView);
