...
import RegistrarSubcomponent from './RegistrarSubcomponent';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class RegistrarViewStudentRecordGradeSubcompView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-registrar-view-student-record-grade-subcomp-view fh">
