...
export class TeacherSummaryView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-teacher-summary-view fh">
        {this.state.isLoading ? (
          ...
          <NavBar>
            <Container>
              <Grid.Row>
                <Grid.Col xs={12} sm={12} md={12}>
                  <TeacherSummary subsectID={this.props.match.params.id} />
                </Grid.Col>
              </Grid.Row>
            </Container>
          </NavBar>
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherSummaryView);
