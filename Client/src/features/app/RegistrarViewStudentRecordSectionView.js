...
import RegistrarViewStudentRecordSection from './RegistrarViewStudentRecordSection';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class RegistrarViewStudentRecordSectionView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-registrar-view-student-record-section-view fh">
...
export default connect(mapStateToProps, mapDispatchToProps)(RegistrarViewStudentRecordSectionView);
