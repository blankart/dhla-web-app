...
import RegistrarManageStudents from './RegistrarManageStudents';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class RegistrarManageStudentsView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-registrar-enroll-students-view fh">
...
export default connect(mapStateToProps, mapDispatchToProps)(RegistrarManageStudentsView);
