...
import TeacherAddRecord from './TeacherAddRecord';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class TeacherAddRecordView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-teacher-add-record-view fh">
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherAddRecordView);
