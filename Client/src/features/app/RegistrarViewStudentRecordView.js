...
import RegistrarViewStudentRecord from './RegistrarViewStudentRecord';
import { Container, Grid } from 'tabler-react';
import { Result, Button } from 'antd';
import axios from 'axios';
import { Link } from 'react-router-dom';

export class RegistrarViewStudentRecordView extends Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="app-registrar-view-student-record-view fh">
...
export default connect(mapStateToProps, mapDispatchToProps)(RegistrarViewStudentRecordView);
