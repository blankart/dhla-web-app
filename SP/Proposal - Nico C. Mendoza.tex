...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item THe student record can be teacher-centric, section-centric, and student-centric
        \end{enumerate}
...
Using spreadsheets have proven to be a useful tool for keeping student records but has disadvantages such as possible data corruption. Difficulties in merging records or grades from different teachers and subjects arise. It also has security problems; the file can be manipulated and modified by anyone without any permission.
...
In addition, this application will also keep parents up to date with their child's performance and will provide a more efficient way of keeping track of students with backlog subjects.
...
\vspace{2cm}
\begin{center}
    Figure 4 - Use Case Diagram, Students' Grade Management System
\end{center}
