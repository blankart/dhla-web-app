...
Web based information system plays a vital role in the educational institutes or colleges in order to maintain the record of the students easily. As far as the matter of students’ academic career is concerned, it is very important to manage the accurate record and up-to-date information so that they can easily access to it. Information system deals with all types of details of the students like course registration, notifications, semester calendar, academic record, exam components, exam slip, time table, attendance detail, students’ feedback and many more as per the needs of any institution. It is very convenient not only for students but also for the parents, principle, registrar, dean to access the academic record of students instantly by just one click. It does not only save time but also the problems faced by the staff. They do not need to use any ink and paper in order to do any sort of work related to that institution. 
...
Mostly the institutions are rated on the availbility of services as well as satisfaction provided to the users. In order to fulfill the needs and expectations of the students, the web based student information system plays a vital role. Therefore, in many universities students are assited by in the form of registration,  issuance of the transcritpts or certificates. Financial recording. ( mare 2011,
Student management system (SMS) software proves beneficial not only for students but also for administrators. Moreover, SMS keeps students aware of any important event, activities etc. (Asogno). However, asogwa et al 2015 observed that the revolution of technology, there rae many universitities in which the staff are still using the same old method for administrative purposes .
Student information system has helped students to view their grades by just entering their roll number in student login panel of university. they do not need to waste their time by standing for hours in a queue. ( students information and accounting system of gagayan state university, SIAS 2018) 

It has been researched that it takes approximately 4 to 5 minutes for freshman in order to register themselves in any institute or universities. Following tables show the result of the students satisfaction for accounting services, registration services, and cashiering services. (SIAS 2018)

93.5\% of admissions into A-Level private schools are performed manually by ink and paper. This manual system has its major problems which include difficulty in locating an appropriate school and subjects an applicant can get admissions, wastage of time, loss of forms and mutilation of forms throughout the entire method for admission. Consequently, this paper reports on an ongoing research work to design and implement a Tanzania central processing admission system (TCPAS) that has the outstanding changes towards maintenance of admission costs, control forgery over entry qualifications, encourage the use of paperless admission, ability to reach several geographically scattered candidates and enhancing centralized data handling capability.

Researchers have observed that one of the greatest achievements of Tanzania is the web based admissions system. They have done a great job in order to monitor and control the quality for admission into technical and tertiary education. 
