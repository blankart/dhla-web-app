...
\begin{enumerate}
	...
	\begin{enumerate}
        ...
        \begin{enumerate}
            \item These grade sheets will also provide student information, name, student number, and section. The name of the teacher will also be included. The administator has also the option to view the records in teacher-centric, section-centric, or student-centric
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item View and update profile
        \item Change his/her password
        \item Input and update grade sheets
        \item View grade sheets
        \item Submit grades
    \end{enumerate}
...
The web application will have six access levels such as the system administrator, director, registrar, teachers, parents/guardians, and students. A context diagram is shown below in Figure 1.
